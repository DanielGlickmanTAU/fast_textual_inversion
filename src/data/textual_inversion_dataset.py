# from textual_inversion import PIL_INTERPOLATION, imagenet_style_templates_small, imagenet_templates_small
...
class TextualInversionDataset(Dataset):
    def __init__(
        ...
        if type(data_root) == str:
            self.image_paths = [os.path.join(self.data_root, file_path) for file_path in os.listdir(self.data_root) if
        ...
        self.templates = imagenet_style_templates_small if learnable_property == "style" else person_templates if learnable_property == 'person' else imagenet_templates_small
